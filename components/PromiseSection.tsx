...
import { Drop, FlowerLotus, Leaf, Rabbit } from "@phosphor-icons/react";
...
const features = [
  ...
  {
    icon: <Rabbit size={36} weight="regular" />,
    title: "Cruelty Free",
    subtitle: "Kind to animals,\nalways.",
  },
  {
    icon: <Drop size={36} weight="regular" />,
    title: "Dermatologist Tested",
    subtitle: "Tested for safety,\nloved by skin",
  },
  {
    icon: <FlowerLotus size={36} weight="regular" />,
...
export default function PromiseSection() {
  return (
    <section className="w-full px-6 md:px-16 py-12 md:py-0 bg-[#f5f0f1] md:h-[650px] flex items-center">
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 items-center">
        ...
        <div className="flex flex-col gap-[10px]">
          ...
          <div className="flex items-center h-[72px]">
            <p
              className="text-text-secondary font-normal text-lunea-text leading-relaxed"
              style={{ opacity: 0.75 }}
            >
